package com.caron.gmall.publisher.controller;

import com.alibaba.fastjson.JSON;
import com.caron.gmall.publisher.service.DauService;
import com.caron.gmall.publisher.service.OrderService;
...
public class PublisherController {
    ...
    public  String   realtimeTotal(@RequestParam("date") String date){
        ...
        BigDecimal orderTotalAmount = orderService.getOrderAmount(date);
